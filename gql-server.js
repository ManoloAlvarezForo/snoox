...
const ItemController = require('./controllers/gql-item');
...
var getItems = function(args) {
    return args._id ? null : ItemController.getItems();
}

var getItem = function(args) {
    return ItemController.getItem(args.itemId);
}
